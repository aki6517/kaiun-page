  ...
  return (
    <div className="space-y-16">
      ...
      <section className="space-y-6 rounded-2xl border border-white/10 bg-[radial-gradient(circle_at_top_right,_rgba(200,168,124,0.24),_rgba(13,11,20,0.8))] p-8 md:p-12">
        <p className="text-xs uppercase tracking-[0.24em] text-[#E8D9C3]">
          月の満ち欠け × タロット × カレンダー
        </p>
        ...
        <p className="max-w-3xl text-base leading-8 text-[#E0CFCB]">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Link
            href="/blog"
            className="rounded-full border border-white/20 px-6 py-3 text-sm font-semibold text-[#C7B0B0]"
          >
            ブログ記事を読む
          </Link>
        </div>
      ...
      <section className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div className="rounded-xl border border-white/10 bg-white/5 p-5">
            ...
            <p className="mt-2 text-sm leading-7 text-[#C7B0B0]">
      ...
      <section className="space-y-4 rounded-2xl border border-white/10 bg-white/5 p-6">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div className="rounded-xl border border-white/15 bg-[#3A3035] p-5">
            <p className="text-sm text-[#E8D9C3]">新月プラン</p>
            <p className="mt-1 text-3xl font-bold">無料</p>
            <p className="mt-3 text-sm text-[#C7B0B0]">基本機能で毎日の運勢をチェック</p>
          </div>
          <div className="rounded-xl border border-[#E8D9C3]/40 bg-[#3A3035] p-5">
            <p className="text-sm text-[#E8D9C3]">満月プラン</p>
            <p className="mt-1 text-3xl font-bold">¥480 / 月</p>
            <p className="mt-3 text-sm text-[#C7B0B0]">
        ...
        <div className="space-y-3">
          {faqItems.map((item) => (
            <details key={item.question} className="rounded-lg border border-white/10 bg-white/5 p-4">
              ...
              <p className="mt-3 text-sm leading-7 text-[#C7B0B0]">{item.answer}</p>
            </details>
          ))}
        </div>
      </section>
      ...
      <section className="rounded-2xl border border-white/10 bg-white/5 p-6 text-center">
        ...
        <p className="mx-auto mt-3 max-w-2xl text-sm leading-7 text-[#C7B0B0]">
